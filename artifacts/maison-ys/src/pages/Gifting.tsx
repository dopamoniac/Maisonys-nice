    ...
    <div className="w-full bg-obsidian min-h-screen text-stone pt-20">
      ...
      <section className="relative h-[80vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <img src={baccaratGiftImg} alt="Cadeaux Maison YS" className="w-full h-full object-cover" />
      ...
      <section className="py-28 container mx-auto px-8 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          ...
          >
            <img src={gridImg} alt="Sélection Maison YS" className="w-full h-full object-cover" />
          </motion.div>
        </div>
      </section>
